...
public class VectorInvertido extends javax.swing.JFrame {

    ArrayList<numeros2>listaorden=new ArrayList<>();
    public VectorInvertido() {
        initComponents();
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblvectorF, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnmostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmostrarActionPerformed
        for(int i=0;i<listaorden.size();i++){
            txtvectorI.append(""+listaorden.get(i).getN()+"\n");
        }
        for(int i=(listaorden.size()-1);i>=0;i--){
            txtvectorF.append(""+listaorden.get(i).getN()+"\n");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VectorInvertido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VectorInvertido().setVisible(true);
            }
        });
    }
